...
import com.minsoft.moviepedia.ViewModel.TopRatedViewModel;
...
public class TopRatedFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        TopRatedViewModel topRatedViewModel = new ViewModelProvider(requireActivity())
        ...
        topRatedViewModel.getTopRatedPagingDataFlowable()
                .to(AutoDispose.autoDisposable(AndroidLifecycleScopeProvider.from(requireActivity())))
                .subscribe(topRatedPagingData -> movieDataAdapter.submitData(getLifecycle(), topRatedPagingData));
